  ...
  load_assignment:	
    ...
    - lb_endpoints:	
      - endpoint:	
          address:	
            socket_address:	
              address: backend-envoy.default.svc.cluster.local
              port_value: 9010
```
...
deployment.apps/frontend-2 configured
```
...
SPIFFE ID     : spiffe://bb-team.org/ns/default/sa/default/backend
Parent ID     : spiffe://bb-team.org/ns/spire/sa/spire-agent
TTL           : 3600
...
SPIFFE ID     : spiffe://bb-team.org/ns/default/sa/default/frontend-2
Parent ID     : spiffe://bb-team.org/ns/spire/sa/spire-agent
TTL           : 3600
Selector      : k8s:ns:default
Selector      : k8s:sa:default
